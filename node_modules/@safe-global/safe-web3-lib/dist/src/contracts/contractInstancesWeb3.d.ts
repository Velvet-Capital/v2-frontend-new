...
export declare function getSafeContractInstance(safeVersion: SafeVersion, safeContract: SafeMasterCopy_V1_3_0 | SafeMasterCopy_V1_2_0 | SafeMasterCopy_V1_1_1 | SafeMasterCopy_V1_0_0): GnosisSafeContract_V1_3_0_Web3 | GnosisSafeContract_V1_2_0_Web3 | GnosisSafeContract_V1_1_1_Web3 | GnosisSafeContract_V1_0_0_Web3;
export declare function getCompatibilityFallbackHandlerContractInstance(safeVersion: SafeVersion, compatibilityFallbackhandlerContract: CompatibilityFallbackHandler_V1_3_0): CompatibilityFallbackHandler_V1_3_0_Web3;
export declare function getMultiSendContractInstance(safeVersion: SafeVersion, multiSendContract: MultiSend_V1_3_0 | MultiSend_V1_1_1): MultiSendContract_V1_3_0_Web3 | MultiSendContract_V1_1_1_Web3;
export declare function getMultiSendCallOnlyContractInstance(safeVersion: SafeVersion, multiSendCallOnlyContract: MultiSendCallOnly_V1_3_0): MultiSendCallOnlyContract_V1_3_0_Web3;
export declare function getGnosisSafeProxyFactoryContractInstance(safeVersion: SafeVersion, gnosisSafeProxyFactoryContract: GnosisSafeProxyFactory_V1_3_0 | GnosisSafeProxyFactory_V1_1_1 | GnosisSafeProxyFactoryContract_V1_0_0_Web3): GnosisSafeProxyFactoryContract_V1_3_0_Web3 | GnosisSafeProxyFactoryContract_V1_1_1_Web3 | GnosisSafeProxyFactoryContract_V1_0_0_Web3;
export declare function getSignMessageLibContractInstance(safeVersion: SafeVersion, signMessageLibContract: SignMessageLib_V1_3_0): SignMessageLibContract_V1_3_0_Web3;
export declare function getCreateCallContractInstance(safeVersion: SafeVersion, createCallContract: CreateCall_V1_3_0): CreateCallContract_V1_3_0_Web3;
